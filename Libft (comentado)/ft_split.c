...
/*   Updated: 2022/12/12 16:18:40 by imoro-sa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	c = '|';
// 	start = 0;
// 	printf("ft_string_counter: %d\n", ft_string_counter(s, c));
// 	printf("ft_string_start: %d\n", ft_string_start(s, c, start));
// 	printf("ft_string_len: %ld\n", ft_string_len(s, c, start));
// 	printf("ft_substr: %s\n", ft_substr(s, start, 6));
// 	printf("ft_split: %s\n", *ft_split(s, c));
// 	return (0);
// }
